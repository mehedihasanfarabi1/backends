    ...
    <>
      ...
      >
        <ul>
          ...
          {/* Party Type */}
          <li onClick={() => toggle("party_type")}>

            <i className="fa-solid fa-people-group me-2"></i>
            <span>{t("party_type")}</span>
            <i className="fa-solid fa-chevron-down ms-auto"></i>
          </li>
          ...
          <ul className={`submenu ms-4 ${open.party_type ? "" : "d-none"}`}>
            ...
            <li>
              ...
              <span>{t("party_list")}</span>
            </li>
            <li>
              <i className="fa-solid fa-percent me-2"></i>
              <span>{t("party_commission")}</span>
            </li>
            <li>
          ...
          <ul className={`submenu ms-4 ${open.settings ? "" : "d-none"}`}>
            ...
            <li onClick={() => navigate("/admin/translations")}>

              ...
              chambers.length ? chambers.map((chamber) => (
                <React.Fragment key={chamber.id}>
                  <tr className="table-info fw-bold">
                    ...
                    <td>
                      <button className="btn btn-sm btn-outline-primary me-1" onClick={() => nav(`/admin/pallet_location/chamber/${chamber.id}`)}>Edit</button>
                  ...
                  {expandedChambers[chamber.id] && chamber.floors.map(floor => (
                    <React.Fragment key={floor.id}>
                      <tr className="bg-light">
                        ...
                        <td>
                          <button className="btn btn-sm btn-outline-primary me-1" onClick={() => nav(`/admin/pallet_location/floor/${floor.id}`)}>Edit</button>
                          ...
                          <td className="ps-5 d-flex gap-3 flex-wrap">
                            {pair.map(pocket => (
                              <div key={pocket.id} className="d-flex align-items-center border rounded p-2">
                                ...
                                <button className="btn btn-sm btn-outline-primary ms-2" onClick={() => setEditingPocketId(pocket.id)}>Edit</button>
